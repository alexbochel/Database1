...
public class BinarySearchTree<T extends Comparable<? super T>> 
     ...
     * @param x Item inserted
     * @param elemRoot Starting point
     * @param currDepth Depth of the current node
     ...
     * 
     * @param rootLocal Root of the tree
     * @param x Entree for height
     * @param height Height of the entree
